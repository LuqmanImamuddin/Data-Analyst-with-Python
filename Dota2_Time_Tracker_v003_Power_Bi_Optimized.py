...
class Dota2Tracker:
    ...
    def open_dota2(self):
        ...
        url = "steam://rungameid/570"  # Replace with the actual URL
        webbrowser.open(url)
    ...
    def close_dota2(self):
        ...
        # There is no direct way to close a web page opened by a web browser using webbrowser module
        # You may manually close the web browser window to simulate closing Dota 2
